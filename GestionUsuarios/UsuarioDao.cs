...
namespace GestionUsuarios
{
    internal class UsuarioDao
    {
        ...
        public void EliminarRegistrosRelacionados(int userId)
        {
            DBConnection conn = new DBConnection();
            string query = "DELETE FROM roles_usuarios WHERE rlu_usr_id = @userId";
            ...
            using (SqlConnection connection = conn.ObtenerConexion())
            {
                ...
                {
                    throw new Exception("Error eliminando registros relacionados: " + ex.Message);
                }
                finally
                {
                    connection.Close();
